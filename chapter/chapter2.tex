...
\martini \ac{FF} developed by Marrink \etal \cite{Martini}.
...
small set of test systems for which some set of target proprieties are reproduced. An important characteristic of a
