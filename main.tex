...
\PassOptionsToPackage{hyperfootnotes=true,hidelinks=true}{hyperref}
...
\clearscrheadfoot
\rohead{\pagemark}
\lehead{\pagemark\qquad\textcolor{gray}{\leftmark}}
...
\include{./chapter/chapter5} %Results
...
\clearscrheadfoot
\rohead{\pagemark}
\lehead{\pagemark\qquad\spacedlowsmallcaps{\textcolor{gray}{\leftmark}}}
\include{./chapter/chapter6} %Summary and conclusion
