...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node[rectangle,draw,rounded corners,very thin,minimum width=5cm,minimum height=1cm,text width=5cm,align=center] (A) at (0,10) {Pair Search \\ \footnotesize{(Domain decomposition update)}};
