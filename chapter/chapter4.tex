...
\begin{figure}[ht!]
	\center
	\includegraphics[width=0.8\textwidth]{./img/CV}
	\caption{Schematic representation of the chosen \acs{CV} and the bias potential deposition along the \acs{CV} space. The richer dashed line is the center of the bilayer.}
