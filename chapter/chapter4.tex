...
\begin{figure}[!ht]
	...
	\caption{First three frame: the concentric $12$--(yellow), $42$--(red) and $60$--(blue) atom gold internal shell, surrounded (last frame) by $30$ gold (red small) and $60$ sulfur (yellow small) surface atoms. The R chains are not shown. Taken from \cite{corePassivated}.}
	\label{fig:goldShell}
\end{figure}
...
treatment of the electrostatic interaction and because the \ac{STD} \martini water is prevalently insensible to 
