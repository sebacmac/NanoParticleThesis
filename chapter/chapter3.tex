...
\begin{itemize}
	...
	\item the topology file in which all the particles of a system are described.%: what kind of forces act between them, the assigned charge, the mass and all the constant refer to the particles and the interactions between them, even this file, generally, is created under the receipt of the \ac{FF} used.
\end{itemize}
